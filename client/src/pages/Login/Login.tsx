             ...
             after:rounded-full after:-z-10 after:blur-xl after:top-24 after:-right-12">
                    <div className="flex-1">
                        <div className="md:pr-[60px]">
                            <img className="h-8 md:h-14 mb-4" src={logo} alt="logo" />
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="text-gray-700   flex items-center justify-center mb-2">
                                    <p>Bạn chưa có tài khoản <a className="text-[#ff8300] after:content-['_↗'] ..." href="/register" target="_blank">Đăng ký</a> ngay</p>
                                </div>
                                <Collapse
                                    items={[{
                                        key: '1', label: 'Hướng dẫn đăng nhập', children:
                                            <div>
                                                <p>
