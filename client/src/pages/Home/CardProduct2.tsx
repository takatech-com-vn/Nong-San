    ...
    return (
        <div className='w-full flex justify-center'>
            <div className="w-full max-h-[350px] rounded-[12px] bg-white relative border-[1px] border-[#ddd]">
                <div className=" rounded-[12px] overflow-hidden p-3">
                    <img className="rounded-[12px]" src={product.product_photo} alt={product.product_title} />
                </div>
                ...
                <div className="px-[16px] flex flex-col justify-between">
                    <div className="w-full h-auto my-[10px] flex flex-col justify-between items-start text-[14px] font-medium">
                        <a href="#" className="overflow-ellipsis overflow-hidden line-clamp-2 max-w-[100%]">{product.product_title}</a>
                    ...
                    <div className="w-full h-[36px] flex flex-row items-center gap-2 ">
                        <span className="text-[16px] text-[#2e2e2e] font-bold">{product.product_price}</span>
                    </div>
                </div>
            </div>
        </div>
